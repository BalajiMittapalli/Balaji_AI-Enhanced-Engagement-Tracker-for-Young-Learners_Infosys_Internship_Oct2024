...
image_dir = 'C:/Desktop/Infosys Springboard Task/guns dataset/images'
label_dir = 'C:/Desktop/Infosys Springboard Task/guns dataset/labels'
output_dir = 'C:/Desktop/Infosys Springboard Task/guns dataset/output'
